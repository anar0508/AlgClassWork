...
class Slider extends Component {
    ...
    showPreviousPicture = () => {
        ...
        if (index === 0) {
            this.setState({ picture: this.state.pictures[0] })
        } else {
            this.setState({ picture: this.state.pictures[index - 1], active: index })
        }
    }
    ...
    showNextPicture = () => {
        ...
        if (index === this.state.pictures.length - 1) {
            this.setState({ picture: this.state.pictures[this.state.pictures.length - 1] })
        } else {

            this.setState({ picture: this.state.pictures[index + 1] })
        }
    }
        ...
        return (
            <div className="container">
                ...
                <div className="buttons">
                    ...
                    <button className={this.state.active === "1" ? "active" : null} onClick={this.showCurrentPicture}>1</button>
                    <button className={this.state.active === "2" ? "active" : null} onClick={this.showCurrentPicture}>2</button>
                    <button className={this.state.active === "3" ? "active" : null} onClick={this.showCurrentPicture}>3</button>
                    <button className={this.state.active === "4" ? "active" : null} onClick={this.showCurrentPicture}>4</button>
                    <button className={this.state.active === "5" ? "active" : null} onClick={this.showCurrentPicture}>5</button>
